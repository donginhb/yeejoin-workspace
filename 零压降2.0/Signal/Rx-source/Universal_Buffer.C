...
*   说明 ：   无                                           *
***********************************************************/
void bufferInit(volatile cBuffer* mbuffer, unsigned char *start, unsigned int size)
{
...
*   说明 ：   长度自动减小 头指针加一                      *
***********************************************************/
unsigned char  bufferGetFromFront(volatile cBuffer* mbuffer)
{
...
*   说明 ：   无                                           *
***********************************************************/
void bufferDumpFromFront(volatile cBuffer* mbuffer, unsigned int numbytes)
{
...
*   说明 ：   这个函数读取后的数据不会被删除               *
***********************************************************/
unsigned char bufferGetAtIndex(volatile cBuffer* mbuffer, unsigned int index)
{
...
*   说明 ：   无                                           *
***********************************************************/
unsigned char bufferAddToEnd(volatile cBuffer* mbuffer, unsigned char dat)
{
...
*   说明 ：   无                                           *
***********************************************************/
unsigned int bufferIsNotFull(volatile cBuffer* mbuffer)
{
...
*   说明 ：   无                                           *
***********************************************************/
void  bufferFlush(volatile cBuffer* mbuffer)
{
...
*   说明 ：   无                                           *
***********************************************************/
unsigned int bufferGetSize(volatile cBuffer* mbuffer)
{
