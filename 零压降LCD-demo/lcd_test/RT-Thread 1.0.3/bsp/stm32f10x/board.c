...
void blink_led(unsigned led, unsigned hz, unsigned cnt)
{
	switch (led) {
			case sys_led_CHANNEL_d1:	/* 1Hz */

				break;
	
			case sys_led_CHANNEL_d2: 
					
				break;
	
			case sys_led_CHANNEL_d3: 
				break;

			case sys_led_CHANNEL_d4: 
				if(0 == (cnt % hz))
					led_blink(led3_gpio, led3_pin);				
				break;

			case sys_led_CHANNEL_d5: 
				if(0 == (cnt % hz))
					led_blink(led4_gpio, led4_pin);
				break;
