...
#endif
extern volatile unsigned int enc28j60_int_cnt_rx;
extern volatile unsigned int enc28j60_int_cnt_tx;
extern volatile unsigned int enc28j60_pkt_cnt_rx;
extern volatile unsigned int enc28j60_pkt_cnt_tx;

/* 等待发送/接收缓冲区的超时时间, ms, 3500 */
#define WAIT_TXRX_BUF_TIME (3500*10)
