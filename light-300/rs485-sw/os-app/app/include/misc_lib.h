...
extern int ui2str(char *str, unsigned int n);
extern int str_reverse(char *str);
extern int byte_reverse(char *str, int n);
...
extern int convert_bcd2str(char *bcd, int blen, char *str, int slen);
...
extern int reset_timer(rt_timer_t timer);
