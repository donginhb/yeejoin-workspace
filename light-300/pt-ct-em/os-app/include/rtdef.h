...
#define MK_VER(m, s, r) 	((m)<<16 | (s)<<8 | (r))

#if PT_DEVICE

#if WIRELESS_MASTER_NODE

#define RT_CUR_APP_VERSION_STR_PTC_M	"0.6.0"

#define LT300_SYS_TYPE_DESCR	"light300-ptc-m"
#define RT_APP_VERSION                  0L      /**< applications major version number */
#define RT_APP_SUBVERSION               6L      /**< applications minor version number */
#define RT_APP_REVISION                	0L      /**< applications revise version number */

/* 版本标记一共有Alpha、Beta、Release和TEMP四种，其中当版本为正式版（Release）时，交给客户的文件名称可以不带版本标记
 * 如：oa_1.2.3.120704。此版本号由项目决定是否修改
 */
#define RT_APP_VER_TYPE		"Alpha"
#define RT_APP_MODIFY_VERSION	0


#define M3_DB_PREV_VERSION 		0L
#define M3_DB_PREV_SUBVERSION 		6L
#define M3_DB_PREV_REVISION		0L

#define M3_DB_VERSION 		0L
#define M3_DB_SUBVERSION 	6L
#define M3_DB_REVISION		0L

#define M3_HW_VERSION 		2L
#define M3_HW_SUBVERSION 	0L
#define M3_HW_REVISION		0L

#elif WIRELESS_SLAVE_NODE

#define RT_CUR_APP_VERSION_STR_PTC_S	"0.6.0"

#define LT300_SYS_TYPE_DESCR	"light300-ptc-s"
#define RT_APP_VERSION                  0L      /**< applications major version number */
#define RT_APP_SUBVERSION               6L      /**< applications minor version number */
#define RT_APP_REVISION                	0L      /**< applications revise version number */
...
#define RT_CUR_APP_VERSION_STR_CTC_M	"0.6.0"

#define LT300_SYS_TYPE_DESCR	"light300-ctc-m"
#define RT_APP_VERSION                  0L      /**< applications major version number */
#define RT_APP_SUBVERSION               6L      /**< applications minor version number */
#define RT_APP_REVISION                	0L      /**< applications revise version number */
...
#define RT_CUR_APP_VERSION_STR_CTC_S	"0.6.0"

#define LT300_SYS_TYPE_DESCR	"light300-ctc-s"
#define RT_APP_VERSION                  0L      /**< applications major version number */
#define RT_APP_SUBVERSION               6L      /**< applications minor version number */
#define RT_APP_REVISION                	0L      /**< applications revise version number */
...
#define RT_CUR_APP_VERSION_STR_EMC_M	"0.6.0"

#define LT300_SYS_TYPE_DESCR	"light300-emc-m"
#define RT_APP_VERSION                  0L      /**< applications major version number */
#define RT_APP_SUBVERSION               6L      /**< applications minor version number */
#define RT_APP_REVISION                	0L      /**< applications revise version number */
...
#define RT_CUR_APP_VERSION_STR_EMC_S	"0.6.0"

#define LT300_SYS_TYPE_DESCR	"light300-emc-s"
#define RT_APP_VERSION                  0L      /**< applications major version number */
#define RT_APP_SUBVERSION               6L      /**< applications minor version number */
#define RT_APP_REVISION                	0L      /**< applications revise version number */
...
#elif EM_MULTI_MASTER_DEV

#define RT_CUR_APP_VERSION_STR_EMM_M	"0.6.2"

#define LT300_SYS_TYPE_DESCR	"light300-emm-m_1024k"
#define RT_APP_VERSION                  0L      /**< applications major version number */
#define RT_APP_SUBVERSION               6L      /**< applications minor version number */
#define RT_APP_REVISION                	2L      /**< applications revise version number */
...
#define RT_CUR_APP_VERSION_STR_EMM_S	"0.6.0"

#define LT300_SYS_TYPE_DESCR	"light300-emm-s_1024k"
#define RT_APP_VERSION                  0L      /**< applications major version number */
#define RT_APP_SUBVERSION               6L      /**< applications minor version number */
#define RT_APP_REVISION                	0L      /**< applications revise version number */
...
#define M3_SYS_TYPE_DESCR	LT300_SYS_TYPE_DESCR
#define SYS_TYPE_DESCR 		LT300_SYS_TYPE_DESCR
...
#define RT_INT8_MAX	((signed char)(~0U & 0x7f))
#define RT_INT8_MIN	(-RT_INT8_MAX - 1)

#define RT_INT16_MAX	((short int)(~0U & 0x7fff))
#define RT_INT16_MIN	(-RT_INT16_MAX - 1)

#define RT_INT32_MAX	((int)(~0U>>1))
#define RT_INT32_MIN	(-RT_INT32_MAX - 1)
...
#define MS_OF_PRE_TICKS        (1000/RT_TICK_PER_SECOND)
#define get_ms_of_ticks(ticks) (MS_OF_PRE_TICKS*(ticks))
/* 向上取整 */
#define get_ticks_of_ms(ms)    ((ms+MS_OF_PRE_TICKS-1)/MS_OF_PRE_TICKS)
/**
 * timer structure
 */
struct rt_timer {
...
#define RT_DEVICE_CTRL_CLR_RXBUF        0x04        /**< clr device rx bug                          */
...
#define RT_DEVICE_CTRL_RTC_CALI_SET     0x12        /** set rtc Calibration value                   */
...
#define IP_DOTTED_DECIMAL_NOTATION(ip) ((ip)>>24 & 0xff), ((ip)>>16 & 0xff), ((ip)>>8 & 0xff), ((ip) & 0xff)
...
#define say_thread_start() do {\
	printf_syn("%s() had start...\n", __FUNCTION__);\
	list_mem();\
	} while (0)
#else
#define say_thread_start()
#endif
