...
#define I2C2_EV_PREEMPTION_PRI		7
#define I2C2_EV_SUB_PRI			0
...
#define SDIO_PREEMPTION_PRI		2
#define SDIO_SUB_PRI			1
...
#define TIM3_PREEMPTION_PRI		3
#define TIM3_SUB_PRI			0

#define TIM2_PREEMPTION_PRI		5
#define TIM2_SUB_PRI			1

#define SI4432_PREEMPTION_PRI		5
#define SI4432_SUB_PRI			0

#define TIM4_PREEMPTION_PRI		3
#define TIM4_SUB_PRI			1

#define RTC_PREEMPTION_PRI		6
#define RTC_SUB_PRI			0

#define TIM5_PREEMPTION_PRI		6
#define TIM5_SUB_PRI			1

/* ADE7880电能脉冲 */
#define ADE7880_EE_PREEMPTION_PRI	0
#define ADE7880_EE_SUB_PRI		0

/* 电表电能脉冲 */
#define EM_EE_PREEMPTION_PRI		0
#define EM_EE_SUB_PRI			1
