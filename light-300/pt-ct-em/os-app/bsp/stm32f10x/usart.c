...
rt_uint8_t  uart4_rx_buffer[UART_SRX_BUFFER_SIZE];
struct stm32_serial_int_rx uart4_int_rx = {uart4_rx_buffer, sizeof(uart4_rx_buffer), 0, 0};
#if RT_UART4_USE_DMA
...
rt_uint8_t  uart5_rx_buffer[UART_SRX_BUFFER_SIZE];
struct stm32_serial_int_rx uart5_int_rx = {uart5_rx_buffer, sizeof(uart5_rx_buffer), 0, 0};
...
#if RT_UART4_USE_DMA
	uart4_dma_tx.dma_channel= UART4_TX_DMA;
