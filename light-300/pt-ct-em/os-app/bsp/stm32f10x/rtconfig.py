...
def GetMacroStr(file_name, macro_name):
	...
	if GetDepend('PT_DEVICE'):
		...
		if GetDepend('WIRELESS_MASTER_NODE'):
			...
			pass
	elif GetDepend('EM_MASTER_DEV'):
		macro_name += '_EMC_M'
	elif GetDepend('EM_SLAVE_DEV'):
		macro_name += '_EMC_S'
	elif GetDepend('EM_MULTI_MASTER_DEV'):
		macro_name += '_EMM_M'
	elif GetDepend('EM_MULTI_SLAVE_DEV'):
		macro_name += '_EMM_S'
	else:
		pass
...
if GetDepend('PT_DEVICE'):
	...
	if GetDepend('WIRELESS_MASTER_NODE'):
		TARGET_VER_NAME = 'light300-ptc-m_'+STM32_FLASH_SIZE+'k_' + app_version[1:-1] + nowtimestr + RT_APP_VER_TYPE
	elif GetDepend('WIRELESS_SLAVE_NODE'):
		TARGET_VER_NAME = 'light300-ptc-s_'+STM32_FLASH_SIZE+'k_' + app_version[1:-1] + nowtimestr + RT_APP_VER_TYPE
	else:
		TARGET_VER_NAME = 'light300-ptc-x_'+STM32_FLASH_SIZE+'k_' + app_version[1:-1] + nowtimestr + RT_APP_VER_TYPE
elif GetDepend('CT_DEVICE'):
	STM32_TYPE = 'STM32F10X_HD'
	STM32_FLASH_SIZE = '512'
	LD_FILE = ' stm32_rom_512kf_64kr.ld'
	...
	if GetDepend('WIRELESS_MASTER_NODE'):
		TARGET_VER_NAME = 'light300-ctc-m_'+STM32_FLASH_SIZE+'k_' + app_version[1:-1] + nowtimestr + RT_APP_VER_TYPE
	elif GetDepend('WIRELESS_SLAVE_NODE'):
		TARGET_VER_NAME = 'light300-ctc-s_'+STM32_FLASH_SIZE+'k_' + app_version[1:-1] + nowtimestr + RT_APP_VER_TYPE
	else:
		TARGET_VER_NAME = 'light300-ctc-x_'+STM32_FLASH_SIZE+'k_' + app_version[1:-1] + nowtimestr + RT_APP_VER_TYPE
elif GetDepend('EM_MASTER_DEV'):
	STM32_TYPE = 'STM32F10X_HD'
	STM32_FLASH_SIZE = '512'
	LD_FILE = ' stm32_rom_512kf_64kr.ld'

	TARGET_VER_NAME = 'light300-emc-m_'+STM32_FLASH_SIZE+'k_' + app_version[1:-1] + nowtimestr + RT_APP_VER_TYPE
elif GetDepend('EM_SLAVE_DEV'):
	STM32_TYPE = 'STM32F10X_HD'
	STM32_FLASH_SIZE = '512'
	LD_FILE = ' stm32_rom_512kf_64kr.ld'

	TARGET_VER_NAME = 'light300-emc-s_'+STM32_FLASH_SIZE+'k_' + app_version[1:-1] + nowtimestr + RT_APP_VER_TYPE
elif GetDepend('EM_MULTI_MASTER_DEV'):
	if 1:
	        STM32_TYPE = 'STM32F10X_XL'
	        STM32_FLASH_SIZE = '1024'
	        LD_FILE = ' stm32_rom_1024kf_96kr.ld'
	elif 0:
	        STM32_TYPE = 'STM32F10X_XL'
	        STM32_FLASH_SIZE = '768'
	...
	TARGET_VER_NAME = 'light300-emm-m_'+STM32_FLASH_SIZE+'k_' + app_version[1:-1] + nowtimestr + RT_APP_VER_TYPE
elif GetDepend('EM_MULTI_SLAVE_DEV'):
	if 1:
	        STM32_TYPE = 'STM32F10X_XL'
	        STM32_FLASH_SIZE = '1024'
	...
	TARGET_VER_NAME = 'light300-emm-s_'+STM32_FLASH_SIZE+'k_' + app_version[1:-1] + nowtimestr + RT_APP_VER_TYPE
else:
...
if PLATFORM == 'gcc':
    ...
    DEVICE = ' -mcpu=cortex-m3 -mthumb -ffunction-sections -fdata-sections'  + ' -D ' + STM32_TYPE + ' -D ' + 'STM32_FLASH_SIZE=' + STM32_FLASH_SIZE
    CFLAGS = ' -Wall ' + DEVICE
