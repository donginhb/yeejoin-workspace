...
#define led5_rcc         RCC_APB2Periph_GPIOE
...
#define EVENT_BIT_NEED_RUN_TIM2_IRQ	(1 << 0)
#define EVENT_BIT_NEED_RUN_TIM4_IRQ	(1 << 1)
#define EVENT_BIT_NEED_RUN_SI4432_MAC_EXTI_IRQ	(1 << 2)
