...
#define RT_APP_SUBVERSION               0L      /**< applications minor version number */
...
#define M3_SYS_TYPE_DESCR "SCC-100"
...
#define is_bit_clr(bit_vector, mask)  (!is_bit_set(bit_vector, mask))
