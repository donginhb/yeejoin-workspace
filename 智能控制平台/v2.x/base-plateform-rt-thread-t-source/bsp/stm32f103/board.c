...
#if 1==USE_TO_7INCH_LCD || 1==STM32_USE_FSMC_NOR_MUX
...
static void GPIO_Configuration(void)
{
	...
	/*
	 * stm32f103ve, FSMC_NOR_mux all signals(FSMC_NOR_mux, FSMC_NAND16只能使用一个)
	 * FSMC_NOR_mux_A16	PD11
	 * FSMC_NOR_mux_A17	PD12
	 * FSMC_NOR_mux_A18	PD13
	 * FSMC_NOR_mux_A19	PE3
	 * FSMC_NOR_mux_A20	PE4
	 * FSMC_NOR_mux_A21	PE5
	 * FSMC_NOR_mux_A22	PE6
	 * FSMC_NOR_mux_A23	PE2
	 * 
	 * FSMC_NOR_mux_DA0	PD14
	 * FSMC_NOR_mux_DA1	PD15
	 * FSMC_NOR_mux_DA2	PD0
	 * FSMC_NOR_mux_DA3	PD1
	 * FSMC_NOR_mux_DA4	PE7
	 * FSMC_NOR_mux_DA5	PE8
	 * FSMC_NOR_mux_DA6	PE9
	 * FSMC_NOR_mux_DA7	PE10
	 * FSMC_NOR_mux_DA8	PE11
	 * FSMC_NOR_mux_DA9	PE12
	 * FSMC_NOR_mux_DA10	PE13
	 * FSMC_NOR_mux_DA11	PE14
	 * FSMC_NOR_mux_DA12	PE15
	 * FSMC_NOR_mux_DA13	PD8
	 * FSMC_NOR_mux_DA14	PD9
	 * FSMC_NOR_mux_DA15	PD10
	 * 
	 * FSMC_NOR_mux_NBL0	PE0
	 * FSMC_NOR_mux_NBL1	PE1
	 * FSMC_NOR_mux_NE1	PD7
	 * FSMC_NOR_mux_NADV	PB7	**
	 * FSMC_NOR_mux_NOE	PD4
	 * FSMC_NOR_mux_NWE	PD5
	 * FSMC_NOR_mux_CLK	PD3	**
	 * FSMC_NOR_mux_NWAIT	PD6	**
	 *
	 * PB.7 -- NADV
	 * PD[0,1], PD[3, 15]
	 * PE[0, 15]
	...
	/* PB.7 used as FSMC_NL(NADV) */
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_7;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;
	GPIO_Init(GPIOB, &GPIO_InitStructure);

	/* PD[0,1], PD[3, 15] ---- PD3, PD6 not use */
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_4 | GPIO_Pin_5 | GPIO_Pin_7
	...
	/* PD.2 EM7164SU16.ZZ */
	GPIO_InitStructure.GPIO_Pin = PSRAM_EM7164_ZZ_PIN;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
	GPIO_Init(PSRAM_EM7164_ZZ_PORT, &GPIO_InitStructure);
	GPIO_SetBits(PSRAM_EM7164_ZZ_PORT, PSRAM_EM7164_ZZ_PIN);
