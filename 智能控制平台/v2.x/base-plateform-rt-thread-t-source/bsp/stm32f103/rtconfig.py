...
CPU='cortex-m3'
CROSS_TOOL='gcc'
LD_FILE = ' stm32f103ve_rom.ld'

TARGET_VER_NAME = 'SCC_2.0.0.' + time.strftime('%Y%m%d',time.localtime()) + '_Alpha_0.'
...
if PLATFORM == 'gcc':
    ...
    LFLAGS = DEVICE + ' -Wl,--gc-sections,-Map=rtthread-stm32.map,-cref,-u,Reset_Handler -T ' + LD_FILE + ' -L./mylib/'
