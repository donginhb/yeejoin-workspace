...
#endif
extern unsigned int athrs27_reg_read(unsigned int s27_addr);
extern void athrs27_reg_write(unsigned int s27_addr, unsigned int s27_write_data);
#if 0 //David
...
extern void ar8228_driver_init();
