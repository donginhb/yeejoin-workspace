...
#if 0 //(RT_CONSOLE_NEED_LOGIN)
volatile int enable_console_print;
#endif
...
void printf_syn(const char *fmt, ...)
{
#if 1
	va_list args;
	rt_size_t length;
	...
	rt_sem_take(&print_sem, RT_WAITING_FOREVER);
