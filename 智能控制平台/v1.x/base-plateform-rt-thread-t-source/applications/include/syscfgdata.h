...
#define NMS_TRAP_LOCK_STATE_ENABLE_BIT	0x02
#define NMS_TRAP_DOOR_STATE_EN_BIT 	0x04
#define NMS_TRAP_TMP_EXC_EN_BIT 	0x08
#define NMS_TRAP_RH_EXC_EN_BIT 		0x10
#define NMS_TRAP_LOCK_EXCEPTION_EN_BIT 	0x20
