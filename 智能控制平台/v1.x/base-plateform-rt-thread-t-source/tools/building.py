...
def PrepareBuilding(env, root_directory, has_libcpu=False):
    ...
    #objs.append(SConscript('bsp/drivers/SConscript', variant_dir='build/bsp/drivers', duplicate=0))
    ...
    #objs.append(SConscript('applications/SConscript', variant_dir='build/applications', duplicate=0))
