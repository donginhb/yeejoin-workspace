 ...
 * I/O pin map
 */
#define USE_LED_TEST 1
#if USE_LED_TEST
#define LED_PORTX   GPIOE
...
#define ELOCK_SWITCH_PORT GPIOE
#define ELOCK_SWITCH_PIN  GPIO_Pin_5
...
/* temperature */
#define TMP_Pin      GPIO_Pin_6
#define TMP_PORT     GPIOE
#define TMP_CLK      RCC_APB2Periph_GPIOE
