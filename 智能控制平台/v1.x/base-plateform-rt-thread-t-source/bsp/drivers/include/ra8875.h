...
#if 1
extern void init_ra8875_keyscan(void);
extern int is_had_hitkey(void);
extern int get_hitkey_num(void);
extern int get_hitkey_code(int serialno);
extern void clr_key_status_bit(void);
#endif
